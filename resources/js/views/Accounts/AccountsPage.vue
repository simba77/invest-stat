...
import {LockClosedIcon, PencilIcon, XCircleIcon, PlusCircleIcon, CashIcon} from "@heroicons/vue/outline";
...
export default {
  name: "AccountsPage",
  components: {SellModal, StatCard, ConfirmModal, BaseModal, PageComponent, PencilIcon, LockClosedIcon, XCircleIcon, PlusCircleIcon, CashIcon},
  mounted() {
    this.getItems();
    this.getStat();
  },
